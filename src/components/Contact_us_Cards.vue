<template>
    <div>
        <div class="container">
            <div class="row text-center">
                <div class="col-xl-6 col-sm-6 mb-5">
                    <div class=" card h-30 rounded-5 shadow py-5 px-4" data-tor="hover:push.up(xs)">
                ...
                <div class="col-xl-6 col-sm-6 mb-5">
                    <div class=" card h-30 rounded-5 shadow py-5 px-4">
                        <div class="card-title">
                        ...
                        <div class="card-body pt-2 fs-5 text-secondary" style=" font-size:large; ">
                            <p>
                                ...
                                handling from the origin countrv to the destination
                            </p>
                             </div>
                    </div>
                </div><!-- End -->
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-xl-6 col-sm-6 mb-5">
                    <div class="  card bg-dark  h-100 rounded-5 shadow py-5 px-4">
                        <div class="card-title">
                ...
                <div class="col-xl-6 col-sm-6 mb-5">
                    <div class=" card bg-secondary h-100 rounded-5 shadow py-5 px-4">
                  ...
                  <form action="">
                    <!-- email -->
                    <input type="text" name="uname" id="myForm" class="form-control my-4 py-2" placeholder="Email"/>
                    <input type="text" name="uname" id="myForm" class="form-control my-4 py-2" placeholder="Username"/>
